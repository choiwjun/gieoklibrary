...
- [x]  오늘 날짜 표시
- [x]  모든 핵심 기능 카드 표시
- [x]  각 카드에 현재 상태 표시 (프로젝트 수, 새 알림 등)
- [x]  카드 클릭 시 해당 기능 페이지로 이동
- [x]  관심 기능이 상단에 우선 표시
- [x]  반응형 그리드 레이아웃
...
- [x]  챕터 목록이 챕터 번호 순으로 표시됨
- [x]  각 챕터 카드에 날짜, AI 생성 제목, 미리보기 텍스트 표시
- [x]  오디오 재생 버튼 (인라인 플레이어)
- [x]  필터 기능 (전체/이번달/지난3개월/올해)
- [x]  통계 표시 (총 챕터 수, 총 녹음 시간)
- [x]  더보기 메뉴 (공유/수정/삭제)
- [x]  PDF 다운로드 버튼
- [x]  챕터가 없을 때 안내 메시지
...
- [x]  AI 처리 중인 챕터의 상태가 명확히 표시되는가?
- [x]  오디오 플레이어가 여러 개 동시에 재생되지 않는가?
- [x]  페이지네이션이 필요한가?
- [x]  로딩 상태가 표시되는가?

---

## [x] M3.4.1: 챕터 상세 조회 (녹음 상세 화면)
...
- [x]  챕터 제목과 날짜 표시
- [x]  오디오 플레이어 (재생/일시정지, 진행바, 재생속도 조절)
- [x]  정리된 텍스트 표시 (20pt, 줄간격 1.8)
- [x]  가족과 공유 기능
- [x]  제목 수정 기능 (인라인 편집)
- [x]  텍스트 수정 모드
- [x]  원본 텍스트 보기 (모달)
...
- [x]  오디오 플레이어가 스크롤 시 고정되는가?
- [x]  텍스트가 시니어 친화적으로 표시되는가?
- [x]  수정 내역이 기록되는가?
- [x]  XSS 방지를 위한 sanitization이 되는가?
